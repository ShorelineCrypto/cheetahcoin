...
This document provides guidelines for internationalization of the Cheetahcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cheetahcoin_en.ts` remains unchanged.
