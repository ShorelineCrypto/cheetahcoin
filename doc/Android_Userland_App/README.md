...
```
After you push TAB afer word "chee" , the android UserLand linux terminal should behave like linux in server/desktop with the full file/folder name "cheetahcoin_2.4.0_arm64_linux-gnu" auto populated for you. 
...
## optional - Load GUI QT wallet into windows/mac/linux Desktop Remotely
 ...
 ```
 hlu@localhost:~$ cd cheetahcoin_2.4.0_arm64_linux-gnu
 hlu@localhost:~/cheetahcoin_2.4.0_arm64_linux-gnu$ ./cheetahcoin-qt &
```
