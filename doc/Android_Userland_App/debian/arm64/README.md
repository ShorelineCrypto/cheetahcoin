...
```
  wget https://github.com/ShorelineCrypto/CheetahCoin/releases/download/v1.7.0.2/cheetahcoin_v1.7.0.2_android_userland_arm.tgz
  tar xvfz cheetahcoin_v1.7.0.2_android_userland_arm.tgz
