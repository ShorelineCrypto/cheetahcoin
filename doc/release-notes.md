Cheetahcoin Core version 0.13.2 is now available from:

  <https://cheetahcoin.org/bin/cheetahcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cheetahcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cheetahcoin-tx to create v2 transactions (btcdrak)
