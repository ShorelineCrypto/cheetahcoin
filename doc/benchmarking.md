...
Cheetahcoin Core has an internal benchmarking framework, with benchmarks
for cryptographic algorithms such as SHA1, SHA256, SHA512 and RIPEMD160. As well as the rolling bloom filter.

After compiling cheetahcoin-core, the benchmarks can be run with:
`src/bench/bench_cheetahcoin`
...
SHA512,384,0.001319904176016,0.002.3.005447388,0.002615700786312
