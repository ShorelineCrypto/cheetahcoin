Cheetahcoin Core version 0.10.4 is now available from:

  <https://cheetahcoin.org/bin/cheetahcoin-core-0.10.4/>
...
- #6953 `43c2789` Split cheetahcoin-tx into its own package
- #6953 `dfe0d4d` Include cheetahcoin-tx binary on Debian/Ubuntu
