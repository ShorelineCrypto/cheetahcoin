Cheetahcoin Core version 0.9.4 is now available from:

  https://cheetahcoin.org/bin/0.9.4/
...
this update is incompatible with the Cheetahcoin system and could lead to consensus
forks.

Cheetahcoin Core released binaries from https://cheetahcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cheetahcoin/+archive/ubuntu/cheetahcoin
- A third-party or self-compiled Cheetahcoin Core

upgrade to Cheetahcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
