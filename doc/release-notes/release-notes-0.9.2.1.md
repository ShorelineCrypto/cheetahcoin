Cheetahcoin Core version 0.9.2.1 is now available from:

  https://cheetahcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CHTA to 0.01 CHTA
...
- Fix "Start cheetahcoin on system login"
