Cheetahcoin Core version 0.13.1 is now available from:

  <https://cheetahcoin.org/bin/cheetahcoin-core-0.13.1/>
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Cheetahcoin wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Cheetahcoin.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Cheetahcoin block need to be stored by nodes in order to validate future
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of cheetahcoins they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of cheetahcoins being spent is exactly
...
- **Increased security for multisig:** Cheetahcoin addresses (both P2PKH addresses
  ...
  believed to be provided by Cheetahcoin's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Cheetahcoin paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Cheetahcoin's current ledger (called the UTXO set),
  ...
  note that Cheetahcoin Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Cheetahcoin users to individually opt-in to almost any change in the Cheetahcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Cheetahcoin Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Cheetahcoin community members are studying several other improvements
...
[Segwit FAQ]: https://cheetahcoincore.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://cheetahcoincore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/cheetahcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/cheetahcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/cheetahcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/cheetahcoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://cheetahcoincore.org/en/2016/06/08/version-bits-miners-faq/
...
Since Cheetahcoin Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/cheetahcoin/bips/blob/master/bip-0147.mediawiki
...
- `cheetahcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `cheetahcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.cheetahcoinstats.com (TheBlueMatt, cdecker)
...
- #8829 `2a8bca4` Add cheetahcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` cheetahcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_cheetahcoinds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update cheetahcoin-tx to output witness data (jnewbery)
