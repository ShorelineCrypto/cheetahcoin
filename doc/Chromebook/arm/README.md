...
```
   tar xvfz cheetahcoin_v1.10.1.3_chromeos_arm.tgz
...
### arm64
```
 hlu@penguin:~$ cd  cheetahcoin_v1.10.1.2_u16_arm64
 hlu@penguin:~/cheetahcoin_v1.10.1.2_u16_arm64$ ./cheetahcoin-qt &
```

### armhf
```
 hlu@penguin:~$ cd  cheetahcoin_v1.10.1.2_u16_armhf
 hlu@penguin:~/cheetahcoin_v1.10.1.2_u16_armhf$ ./cheetahcoin-qt &
```
...
```
After you push TAB afer word "cheetahc" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "cheetahcoin_v1.10.1.2_u16_arm64" auto populated for you. 
