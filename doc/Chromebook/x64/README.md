...
## run GUI QT wallet in Chromebook
 ...
 ```
 hlu@penguin:~$ cd  cheetahcoin_2.5.0_x86_64_linux-gnu
 hlu@penguin:~/cheetahcoin_2.5.0_x86_64_linux-gnu$ ./cheetahcoin-qt &
```
...
```
   cd  cheetahcoin_2.5.0_x86_64_linux-gnu
...
```
After you push TAB afer word "cheec" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "cheetahcoin_2.5.0_x86_64_linux-gnu" auto populated for you. 
