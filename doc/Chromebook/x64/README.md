...
```
   tar xvfz cheetahcoin_v1.6.0.3_chromeos_x64.tgz
...
## run GUI QT wallet in Chromebook
 ...
 ```
 hlu@penguin:~$ cd  cheetahcoin_v1.6.0.0_ubuntu16.04
 hlu@penguin:~/cheetahcoin_v1.6.0.0_ubuntu16.04$ ./cheetahcoin-qt &
```
...
```
   cd  cheetahcoin_v1.6.0.0_ubuntu16.04
...
```
After you push TAB afer word "cheetahc" , the chromebook linux terminal should behave like linux in server/desktop with the full file/folder name "cheetahcoin_v1.6.0.0_ubuntu16.04" auto populated for you. 
