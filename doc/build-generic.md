GENERIC BUILD NOTES
====================
Some notes on how to build Cheetahcoin based on the [depends](../depends/README.md) build system.
...
------------------------------------
Building the dependencies and Cheetahcoin requires some essential build tools to be installed before. Please see
...
This will download and build all dependencies required to build Cheetahcoin. Caching of build results will ensure that only
...
level. `./configure` of Cheetahcoin will autodetect the presence of ccache and enable use of it. To disable ccache, use
