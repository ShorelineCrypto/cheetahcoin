...
# TestNode: A peer we use to send messages to cheetahcoind, and store responses.
...
class CompactBlocksTest(CheetahcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes cheetahcoind to (reasonably!) disconnect us, so do this last.
    ...
    # cheetahcoind's choice of nonce.
    ...
    # Test that cheetahcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cheetahcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cheetahcoind will not send blocktxn responses for blocks whose height is
