...
unlocked to sign the Cheetahcoin-Qt.app bundle.
...
allowing somebody to distribute a Cheetahcoin-Qt.app or cheetahcoin-qt-setup.exe with a valid
...
that the cheetahcoin-qt.exe file inside the installer had not been tampered with.
