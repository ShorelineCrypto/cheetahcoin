...
#ifndef H_CHEETAHCOIN_SCRIPT
#define H_CHEETAHCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCheetahcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Cheetahcoin always counted CHECKMULTISIGs
