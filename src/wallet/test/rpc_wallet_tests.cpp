// Copyright (c) 2013-2015 The Cheetahcoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CCheetahcoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CCheetahcoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CCheetahcoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CCheetahcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CCheetahcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CCheetahcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
