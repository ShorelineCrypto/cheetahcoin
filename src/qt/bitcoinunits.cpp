...
QString CheetahcoinUnits::description(int unit)
{
    ...
    case mCHTA: return QString("Milli-Cheetahcoins (1 / 1,000)");
    case uCHTA: return QString("Micro-Cheetahcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
int CheetahcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case CHTA: return 8; // 21,000,000 (# digits, without commas)
    case mCHTA: return 11; // 21,000,000,000
    case uCHTA: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
...
QString CheetahcoinUnits::format(int unit, qint64 n, bool fPlus)
{
...
QString CheetahcoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign)
{
    return format(unit, amount, plussign) + QString(" ") + name(unit);
}

bool CheetahcoinUnits::parse(int unit, const QString &value, qint64 *val_out)
{
