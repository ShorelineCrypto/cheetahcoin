...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CheetahcoinUnits::SeparatorStyle separators=CheetahcoinUnits::separatorStandard) const;
...
#endif // CHEETAHCOIN_QT_TRANSACTIONTABLEMODEL_H
