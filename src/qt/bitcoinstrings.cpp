...
QT_TRANSLATE_NOOP("bitcoin-core", "Listen for connections on <port> (default: 8537 or testnet: 18537)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Cheetahcoin Wiki for SSL setup instructions)"),
