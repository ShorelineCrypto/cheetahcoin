...
#ifndef CHEETAHCOIN_QT_CHEETAHCOINUNITS_H
#define CHEETAHCOIN_QT_CHEETAHCOINUNITS_H
...
/** Cheetahcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CheetahcoinUnits: public QAbstractListModel
{
    Q_OBJECT
...
typedef CheetahcoinUnits::Unit CheetahcoinUnit;

#endif // CHEETAHCOIN_QT_CHEETAHCOINUNITS_H
