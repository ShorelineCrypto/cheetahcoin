...
#ifndef CHEETAHCOIN_QT_WALLETMODEL_H
#define CHEETAHCOIN_QT_WALLETMODEL_H
...
/** Interface to Cheetahcoin wallet from Qt view code. */
...
#endif // CHEETAHCOIN_QT_WALLETMODEL_H
