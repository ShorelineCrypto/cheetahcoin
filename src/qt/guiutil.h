...
#ifndef CHEETAHCOIN_QT_GUIUTIL_H
#define CHEETAHCOIN_QT_GUIUTIL_H
...
namespace GUIUtil
{
    ...
    // Parse "cheetahcoin:" URI into recipient object, return true on successful parsing
...
#endif // CHEETAHCOIN_QT_GUIUTIL_H
