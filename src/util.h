...
extern const char * const CHEETAHCOIN_CONF_FILENAME;
extern const char * const CHEETAHCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("cheetahcoin-%s", name);
