...
{
    BOOST_CHECK(TestSplitHost("www.cheetahcoin.org", "www.cheetahcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cheetahcoin.org]", "www.cheetahcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.cheetahcoin.org:80", "www.cheetahcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cheetahcoin.org]:80", "www.cheetahcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8537", "127.0.0.1", 8537));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8537", "127.0.0.1", 8537));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8537", "::ffff:127.0.0.1", 8537));
    BOOST_CHECK(TestSplitHost("[::]:8537", "::", 8537));
    BOOST_CHECK(TestSplitHost("::8537", "::8537", -1));
    BOOST_CHECK(TestSplitHost(":8537", "", 8537));
    BOOST_CHECK(TestSplitHost("[]:8537", "", 8537));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8537", "127.0.0.1:8537"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8537", "[::]:8537"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
