...
#ifndef CHEETAHCOIN_TEST_SCRIPTNUM10_H
#define CHEETAHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cheetahcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CHEETAHCOIN_TEST_BIGNUM_H
